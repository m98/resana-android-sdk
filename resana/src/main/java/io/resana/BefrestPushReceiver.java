 ...
 */
abstract class BefrestPushReceiver extends BroadcastReceiver {
    private static final String TAG = ResanaLog.TAG_PREF + "BefrestPushRecei";
    ...
    static final String ACTION_BEFREST_PUSH = "io.resana.ACTION_AD_RECEIVED";
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        ResanaLog.v(TAG, "Broadcast Received :: type: " + type + "      timeSent:" + timeSent);
        switch (type) {
            case PUSH:
                Parcelable[] p = intent.getParcelableArrayExtra(BefrestImpl.Util.KEY_MESSAGE_PASSED);
                Ad[] bm = new Ad[p.length];
            ...
            case BEFREST_CONNECTED:
                ...
                break;
            default:
                ResanaLog.e(TAG, "BefrestImpl Internal ERROR! Unknown BefrestImpl Action!!");
        }
    }
     ...
     */
    abstract public void onPushReceived(Context context, Ad[] messages);
