...
final class ResanaLog {
    ...
    static void setLogLevel(int logLevel) {
        ResanaLog.logLevel = logLevel;
    }

    private static volatile ResanaLog Instance = null;

    private static ResanaLog getInstance() {
        ResanaLog localInstance = Instance;
        if (localInstance == null) {
            synchronized (ResanaLog.class) {
                localInstance = Instance;
                if (localInstance == null) {
                    Instance = localInstance = new ResanaLog();
                }
            }
        }
    ...
    private ResanaLog() {
        ...
        try {
            ...
            Log.v("ResanaLog File", "path : " + LogsDir);
